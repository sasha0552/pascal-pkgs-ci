...
1. vLLM `0.5.5`, `0.6.0`, `0.6.1`, `0.6.1.post1`, `0.6.1.post`, `0.6.2`, `0.6.3`, `0.6.3.post1`, `0.6.4`, `0.6.4.post1`, `0.6.5`, `0.6.6`, `0.6.6.post1`, `0.7.0` and `main` (nightly, updates daily) are available in this repository.
...
```sh
# Pull the vLLM image
docker pull ghcr.io/sasha0552/vllm:v0.7.0  # you can omit the version specifier
...
# Install vLLM
pip3 install vllm-pascal==0.7.0  # you can omit the version specifier
                                 # to install nightly version
